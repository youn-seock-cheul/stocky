...
class MarketAnalyzer:
    ...
    def generate_analysis(self, market_data, report_type="opening", trade_info=None):
        ...
        models_to_try = ['gemini-3.5-flash', 'gemini-3.1-flash-lite', 'gemini-3.0-flash', 'gemini-2.5-flash']
    ...
    def extract_portfolio_from_image(self, image_path):
        try:
            ...
            """
            response = self._safe_generate_content(model='gemini-3.1-flash-lite', contents=[prompt, img])
